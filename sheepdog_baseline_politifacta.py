# -*- coding: utf-8 -*-
"""SheepDog-Baseline-PolitifactA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Ke-LhTscC7kCMVJ3LkxVz-vCE00_i6K3
"""

!pip install --upgrade pip

# !pip install -U "torch==2.4.0" "torchvision==0.19.0" "torchaudio==2.4.0" \
...
!pip install empath
# # NLP deps (safe to re-run)
# !pip install -U transformers sentencepiece datasets scikit-learn tqdm


# Evaluation + utilities
!pip install scikit-learn tqdm

# Optional: for logging / visualization
...
# %cd /content/SheepDog
# (optional) confirm utils exists here
!ls -la

# Make sure Python can import from the current folder
import sys, os
...
#Ignore unknown args from Jupyter
